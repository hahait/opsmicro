  ...
  <div class="group-container">
    ...
    <el-dialog
      ...
      <el-form :inline="true" size="small" style="float: right">
        <el-form-item>
          <el-input v-model="permsParams.path" placeholder="请求路径" />
        </el-form-item>
        <el-form-item>
          <el-input v-model="permsParams.method" placeholder="请求方法" />
        </el-form-item>
        <el-form-item>
...
<script>
import { getGroupList, editGroupUsers, deleteGroup, addGroup, editGroup, editGroupPerms } from '@/api/accounts/group'
...
export default {
  ...
  methods: {
    ...
    changeGroupPermisssion: function(row) {
      this.permsParams = { path: '', method: '', page: 1, page_size: 10 }
    ...
    // 修改用户组权限提交
    commitChangeGroupPermission: function(data) {
      editGroupPerms(data).then(
        () => {
          this.$message({
