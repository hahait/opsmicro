...
func (c *userService) QueryUser(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *userHandler) QueryUser(ctx context.Context, in *Request, out *Response) error {
